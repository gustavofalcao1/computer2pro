    ...
    return {
        ...
        init: function() 
        {
		    ...
		    if(jQuery('#wpem-dashboard-event-list-wrapper .wpem-event-dashboard-information-toggle').length >0)
		    {
				...
				jQuery('#wpem-dashboard-event-list-wrapper')
					.on('click', '.event-dashboard-action-details', function() {
			...
			if(jQuery('.wpem-dashboard-main-header .wpem-event-dashboard-filter-toggle').length >0)
		    {
				...
				jQuery('.wpem-dashboard-main-header .wpem-dashboard-main-filter')
					.on('click', '.wpem-dashboard-event-filter', function() {
